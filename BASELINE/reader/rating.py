...
class RatingGetter(object):
    ...
    def __init__(self, k):
        ...
        self.config.rating_cv_path = "../data/douban_book_ratings_cv/"
        self.config.max_val = 5.0
        self.config.dataset_name = "douban_book"
        self.config.sep = '\t'
        self.config.rating_path ="../data/douban_book/user_item.dat"
        
        #douban movie ratings
        self.config.rating_cv_path = "../data/douban_movie_ratings_cv/"
        self.config.max_val = 5.0
        self.config.dataset_name = "douban_movie"
        self.config.sep = '\t'
        self.config.rating_path ="../data/douban_movie/user_item.dat"
        '''
        #yelp ratings
        self.config.rating_cv_path = "../data/yelp_ratings_cv/"
        self.config.max_val = 5.0
        self.config.dataset_name = "yelp"
        self.config.sep = '\t'
        self.config.rating_path ="../data/yelp/user_item.dat"
