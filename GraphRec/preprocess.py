...
if args.dataset == 'douban_book':
	click_f = np.loadtxt(workdir+'douban_book/user_book.txt', dtype = np.int32)
	trust_f = np.loadtxt(workdir+'douban_book/trust.txt', dtype = np.int32)
elif args.dataset == 'douban_movie':
	click_f = np.loadtxt(workdir+'douban_movie/user_movie.txt', dtype = np.int32)
	trust_f = np.loadtxt(workdir+'douban_movie/trust.txt', dtype = np.int32)
elif args.dataset == 'yelp':
	click_f = np.loadtxt(workdir+'yelp/user_business.txt', dtype = np.int32)
	trust_f = np.loadtxt(workdir+'yelp/trust.txt', dtype = np.int32)
else:
	pass 
